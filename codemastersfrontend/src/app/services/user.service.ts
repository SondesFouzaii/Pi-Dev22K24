...
export class UserService {
  ...
  // import random users for the datamigning part
  addRandomUsers(users: any[]): Observable<number> {
    return this.http.post<number>(`${this.apiServerUrl}/import-users-json`, users);
  }
